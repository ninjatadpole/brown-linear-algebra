...
## Task 3
divisible_by_3 = (673+909)/3 == (673+909)//3
...
three_digits_set = {x*base**0 + y*base**1 + z*base**2 for x in digits for y in digits for z in digits if x<base and y<base and z<base}
...
## Task 17
L1 = [0,0,0] # <-- want len(L1) != len(list(set(L1)))
...
base = 10
digits = set(range(10))
representation_dict = {(x*base**0 + y*base**1 + z*base**2):[z, y, x] for x in digits for y in digits for z in digits if x<base and y<base and z<base}
